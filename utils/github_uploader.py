...
BASE_PROJECT_DIR = os.path.abspath(os.getcwd())
...
def upload_to_github(project_path, data):
    ...
    try:
        ...
        # Step 5: Go back to base dir and delete project folder
        os.chdir(BASE_PROJECT_DIR)
        shutil.rmtree(full_project_path)

        return {"success": True, "message": "Project uploaded and cleaned up successfully."}
